...
class MVCNNDataLayerPreTrain(caffe.Layer):
  ...
  def setup(self, bottom, top):
    ...
    print('image set directory : '+ self._dataPath)
    self._batch_size = layer_params['batch_size']
    print('batch size set to : '+ str(self._batch_size))
    ...
    top[0].reshape(self._batch_size,self._channel_Size, IMW, IMH)
  ...
  def _loadSampleImage(self, modelName):
    mean_file = np.load('/mnt/c/Users/john/Desktop/these_jon/python_projects/NET_K33/ilsvrc_2012_mean.npy')
